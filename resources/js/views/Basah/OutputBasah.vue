	...
	<div>
		<nav class="page-breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Output Index</li>
			</ol>
		</nav>
		...
		<div class="row">
			<div class="col-md-12 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						<h6 class="card-title">Output Record in <b>Gudang Pembahanan Basah</b></h6>
...
export default {
	...
	methods: {
		...
		async rollbackAction() {
			...
			try {
				let response = await axios.patch(
					`/api/gudang-p-basah/output-index/rollback/${this.form.id}`,
					this.form
				);
		...
		async toggleBusy() {
			...
			let { data } = await axios.get("/api/gudang-p-basah/output-index");
			this.stocks = [];
