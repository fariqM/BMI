	...
	<div>
		...
		<div class="row">
			<div class="col-md-12 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						<h6 class="card-title">Index of Output in <b>Gudang COATING</b></h6>
...
export default {
	...
	methods: {
		...
		async rollbackAction() {
			...
			try {
				let response = await axios.patch(
					`/api/gudang-coating/output-index/rollback/${this.form.id}`,
					this.form
				);
		...
		async toggleBusy() {
			...
			let { data } = await axios.get("/api/gudang-coating/output-index");
			this.stocks = [];
