            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">Read the <a href="https://www.tiny.cloud/docs/"
                                                                target="_blank"> Official TinyMCE
            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">Read the <a href="https://simplemde.com/"
                                                                target="_blank"> Official SimpleMDE
                                Documentation </a>for a full list of instructions and other options.</p>
                        <textarea class="form-control" name="tinymce" id="simpleMdeExample"
                                  rows="10"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">Read the <a href="https://ace.c9.io/" target="_blank">
                                Official Ace Editor Documentation </a>for a full list of instructions and other
                            options.</p>
                        <div class="row">
