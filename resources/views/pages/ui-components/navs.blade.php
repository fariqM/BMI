        ...
        <div class="row">
            <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
                ...
                <p class="lead">Documentation and examples for how to use Bootstrap’s included navigation
                    components. Read the <a href="https://getbootstrap.com/docs/4.5/components/navs/"
                ...
                <p class="mb-3">Navigation available in Bootstrap share general markup and styles, from the
                    base <code>.nav</code> class to the active and disabled states. Swap modifier classes to
                    switch between each style.</p>
                <div class="example">
                    <ul class="nav">
                        <li class="nav-item">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="nav">
  ...
  <li class="nav-item">
    <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Disabled</a>
                ...
                <p class="mb-3">Change the horizontal alignment of your nav with flexbox utilities. By
                    default, navs are left-aligned, but you can easily change them to center or right
                    aligned.</p>
                <div class="example">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="nav justify-content-center">
  ...
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#hAlignment"><i
                            data-feather="copy"></i></button>
                </figure>
                <div class="example">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="nav justify-content-end">
  ...
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#hAlignmentB"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Stack your navigation by changing the flex item direction with the
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="nav justify-content-center">
  ...
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#vAlignment"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <h4 id="tabs">Tabs</h4>
                <p class="mb-3">Takes the basic nav from above and adds the <code>.nav-tabs</code> class to
                    generate a tabbed interface.</p>
                <div class="example">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="nav nav-tabs">
  ...
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#Tabs"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Force your <code>.nav</code>’s contents to extend the full available width
                    one of two modifier classes. To proportionately fill all available space with your
                    <code>.nav-item</code>s, use <code>.nav-fill</code>.</p>
                <div class="example">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="nav nav-fill">
  ...
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#fillJustify"><i
                            data-feather="copy"></i></button>
                </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Disabled</a>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#tabsDropdown"><i
                            data-feather="copy"></i></button>
                </figure>
