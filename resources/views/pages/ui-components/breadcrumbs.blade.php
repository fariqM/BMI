    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
                ...
                <p class="lead">Indicate the current page’s location within a navigational hierarchy that
                    automatically adds separators via CSS. Read the <a
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-primary">
    ...
    <li class="breadcrumb-item active" aria-current="page">Data</li>
                    ...
                    <button type="button" class="btn btn-clipboard"
                            data-clipboard-target="#colorVariations"><i data-feather="copy"></i></button>
                </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-inverse-primary">
    ...
    <li class="breadcrumb-item active" aria-current="page">Data</li>
                    ...
                    <button type="button" class="btn btn-clipboard"
                            data-clipboard-target="#inverseBreadcrumbs"><i data-feather="copy"></i></button>
                </figure>

                <hr>

                <h4 id="changing-seperator">Changing the separator</h4>
                <p class="mb-3">Separators are automatically added in CSS through <a
                        href="https://developer.mozilla.org/en-US/docs/Web/CSS/::before"><code>::before</code></a>
                    and
                    <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/content"><code>content</code></a>.
                    They can be changed by changing <code>$breadcrumb-divider</code>. The <a
                        href="https://sass-lang.com/documentation/Sass/Script/Functions.html#quote-instance_method">quote</a>
                    function is needed to generate the quotes around a string, so if you want
                    <code>&gt;</code> as separator, you can use this:</p>
                <figure class="highlight" id="divider">
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#divider"><i
                ...
                <figure class="highlight" id="base64">
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#base64"><i
                            data-feather="copy"></i></button>
                </figure>
                <p class="mb-3">The separator can be removed by setting <code>$breadcrumb-divider</code> to
                    <code>none</code>:</p>
                <figure class="highlight" id="seperatorNone">
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#seperatorNone">
