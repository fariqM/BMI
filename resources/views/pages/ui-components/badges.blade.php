    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
                ...
                <p class="lead">Documentation and examples for badges, our small count and labeling
                    component. Read the <a href="https://getbootstrap.com/docs/4.5/components/badge/"
                ...
                <p class="mb-3">Badges scale to match the size of the immediate parent element by using
...
<h6>Example heading <span class="badge badge-primary">New</span></h6></script></code></pre>
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#defaultBadge"><i
                            data-feather="copy"></i></button>
                </figure>
                <p class="mb-3 mt-5">Badges can be used as part of links or buttons to provide a
                    counter.</p>
                <div class="example">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><button type="button" class="btn btn-primary">
	Notifications <span class="badge badge-light">4</span>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#buttonBadge"><i
                            data-feather="copy"></i></button>
                </figure>
                <hr>
                <h4 id="contextual-variations">Contextual variations</h4>
                <p class="mb-3">Add any of the below mentioned modifier classes to change the appearance of
                    a badge.</p>
                <div class="example">
...
<span class="badge badge-dark">Dark</span></script></code></pre>
                    <button type="button" class="btn btn-clipboard"
                            data-clipboard-target="#contextualVariations"><i data-feather="copy"></i>
                    </button>
                </figure>
                <hr>
                <h4 id="pill-badges">Pill badges</h4>
                <p class="mb-3">Use the <code>.badge-pill</code> modifier class to make badges more rounded
                    (with a larger border-radius and additional horizontal padding).</p>
                <div class="example">
                ...
                <figure class="highlight" id="pillBadges">
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#pillBadges"><i
                            data-feather="copy"></i></button>
                </figure>
                <hr>
                <h4 id="link-badges">Link badges</h4>
                <p class="mb-3">Using the contextual <code>.badge-*</code> classes on an
                    <code>&lt;a&gt;</code> element quickly provide actionable badges with hover and focus
                    states.</p>
                <div class="example">
                ...
                <figure class="highlight" id="linkBadges">
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#linkBadges"><i
                            data-feather="copy"></i></button>
                </figure>
            </div>
