    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
                ...
                <p class="lead">To indicate a series of related content exists across multiple pages. Read
                    the <a href="https://getbootstrap.com/docs/4.5/components/pagination/" target="_blank">Official
                        Bootstrap Documentation</a> for a full list of instructions and other options.</p>

                <hr>

                <h4 id="default">Basic example</h4>
                <p class="mb-3">Pagination is built with list HTML elements so screen readers can announce
                    the number of available links.</p>
                <div class="example">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><nav aria-label="Page navigation example">
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="#"><i data-feather="chevron-right"></i></a></li>
                ...
                <p class="mb-3">Add <code>.pagination-lg</code> or <code>.pagination-sm</code> for
                    additional sizes.</p>
                <div class="example">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="pagination pagination-sm">
  ...
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#sizingSm"><i
                            data-feather="copy"></i></button>
                </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="pagination justify-content-end">
  ...
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#alignmentEnd"><i
                            data-feather="copy"></i></button>
                </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="pagination pagination-separated">
  ...
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#Seperated"><i
                            data-feather="copy"></i></button>
                </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="pagination pagination-rounded">
  ...
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#Rounded"><i
                            data-feather="copy"></i></button>
                </figure>
