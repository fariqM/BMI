    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
                ...
                <p class="lead">Dropdowns are toggleable, contextual overlays for displaying lists of links
                    and more. They’re made interactive with the included Bootstrap dropdown javascript
                    plugin. Read the <a href="https://getbootstrap.com/docs/4.5/components/dropdowns/"
                ...
                <p class="mb-3">Wrap the dropdown’s toggle (your button or link) and the dropdown menu
                    within <code>.dropdown</code>, or another element that declares position relative.
	...
	<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
		...
		<a class="dropdown-item" href="#">Something else here</a>
                    ...
                    <button type="button" class="btn btn-clipboard"
                            data-clipboard-target="#defaultDropdown"><i data-feather="copy"></i></button>
                </figure>
                ...
                <div class="example">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-secondary dropdown-toggle"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Secondary
                        </button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#">Action</a>
                            <a class="dropdown-item" href="#">Another action</a>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="btn-group">
	...
	<div class="dropdown-menu">
		...
		<a class="dropdown-item" href="#">Something else here</a>
                    ...
                    <button type="button" class="btn btn-clipboard"
                            data-clipboard-target="#dropdownVariations"><i data-feather="copy"></i></button>
                </figure>

                <hr>

                <h4 id="split">Split button</h4>
                <p class="mb-3">Similarly, create split button dropdowns with virtually the same markup as
                    single button dropdowns, but with the addition of <code>.dropdown-toggle-split</code>
                    for proper spacing around the dropdown caret.</p>
                <div class="example">
                    <div class="btn-group">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="btn-group">
	...
	<div class="dropdown-menu">
		...
		<a class="dropdown-item" href="#">Something else here</a>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#splitButton"><i
                ...
                <p class="mb-3">Button dropdowns work with buttons of all sizes, including default and split
                    dropdown buttons.</p>
                <div class="example">
...
<div class="btn-group">
	...
	<div class="dropdown-menu">
		...
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#buttonSizing"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Trigger dropdown menus above elements by adding <code>.dropup</code> to the
                    parent element.</p>
                <div class="example">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="btn-group dropup">
	...
	<div class="dropdown-menu">
		...
		<a class="dropdown-item" href="#">Something else here</a>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#dropUP"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Trigger dropdown menus at the right of the elements by adding <code>.dropright</code>
...
<div class="btn-group dropright">
	...
	<div class="dropdown-menu">
		<!-- Dropdown menu links -->
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#dropRight"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Trigger dropdown menus at the right of the elements by adding <code>.dropleft</code>
                    to the parent element.</p>
                <div class="example">
...
<div class="btn-group">
	...
	<button type="button" class="btn btn-secondary">
		Split dropleft
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#dropLeft"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Add <code>.active</code> to items in the dropdown to <strong>style them as
                        active</strong>.</p>
                <div class="example">
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle" type="button"
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="dropdown">
	...
	<div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
		...
		<a class="dropdown-item" href="#">Something else here</a>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#activeItem"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Add <code>.disabled</code> to items in the dropdown to <strong>style them as
                        active</strong>.</p>
                <div class="example">
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle" type="button"
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="dropdown">
	...
	<div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
		...
		<a class="dropdown-item" href="#">Something else here</a>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#disabledItem"><i
                            data-feather="copy"></i></button>
                </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="dropdown">
	...
	<div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
		...
		<a class="dropdown-item" href="#">Something else here</a>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#dropdownHeader">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="dropdown">
	...
	<div class="dropdown-menu" aria-labelledby="dropdownMenuButton4">
		...
		<a class="dropdown-item" href="#">Separated link</a>
                    ...
                    <button type="button" class="btn btn-clipboard"
                            data-clipboard-target="#dropdownDividers"><i data-feather="copy"></i></button>
                </figure>

                <hr>

                <h4 id="dropdown-text">Text in dropdown</h4>
                <p class="mb-3">Place any freeform text within a dropdown menu with text and use spacing
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="dropdown">
	...
	<div class="dropdown-menu p-4 text-muted"  aria-labelledby="dropdownMenuButton5">
		...
		<p class="mb-0">And this is more example text.</p>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#dropdownText"><i
                            data-feather="copy"></i></button>
                </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="dropdown">
	...
	<form class="dropdown-menu p-4"  aria-labelledby="dropdownMenuButton6">
		...
		<button type="submit" class="btn btn-primary">Sign in</button>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#dropdownForm"><i
                            data-feather="copy"></i></button>
                </figure>
