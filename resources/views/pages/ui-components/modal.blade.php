    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
                ...
                <p class="lead">Add dialogs to your site for lightboxes, user notifications, or completely
                    custom content. Read the <a href="https://getbootstrap.com/docs/4.5/components/modal/"
                                                target="_blank">Official Bootstrap Documentation</a> for a
                    full list of instructions and other options.</p>
                <hr>
                <h4 id="default">Basic example</h4>
                <p class="mb-3">Below is a <em>static</em> modal example (meaning its <code>position</code>
                    and <code>display</code> have been overridden).</p>
                <div class="example">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Save changes</button>
                ...
                <p class="mb-3">Toggle a working modal demo by clicking the button below. It will slide down
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Save changes</button>
                ...
                <p class="mb-3">When modals become too long for the user’s viewport or device, they scroll
                ...
                <p class="my-3">You can also create a scrollable modal that allows scroll the modal body by
                ...
                <p class="mb-3">Add <code>.modal-dialog-centered</code> to <code>.modal-dialog</code> to
                ...
                <p class="mb-3">Have a bunch of buttons that all trigger the same modal with slightly
                    different contents? Use <code>event.relatedTarget</code> and <a
                        href="https://developer.mozilla.org/en-US/docs/Learn/HTML/Howto/Use_data_attributes">HTML
                        <code>data-*</code> attributes</a> (possibly <a href="https://api.jquery.com/data/">via
                        jQuery</a>) to vary the contents of the modal depending on which button was clicked.
                </p>
                <div class="example">
                    <button type="button" class="btn btn-primary" data-toggle="modal"
                            data-target="#varyingModal" data-whatever="@mdo">Open modal for @mdo
                    </button>
                    <button type="button" class="btn btn-primary" data-toggle="modal"
                            data-target="#varyingModal" data-whatever="@fat">Open modal for @fat
                    </button>
                    <button type="button" class="btn btn-primary" data-toggle="modal"
                            data-target="#varyingModal" data-whatever="@getbootstrap">Open modal for
                        @getbootstrap
                    </button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Send message</button>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#varyingContent">
...
<pre><code class="language-javascript"><script type="script/prism-javascript-markup">$('#exampleModal').on('show.bs.modal', function (event) {
    ...
    modal.find('.modal-body input').val(recipient)
                    ...
                    <button type="button" class="btn btn-clipboard"
                            data-clipboard-target="#varyingContentScript"><i data-feather="copy"></i>
                    </button>
                </figure>
                ...
                <p class="mb-3">Modals have three optional sizes. Add <code>.modal-sm</code>, <code>.modal-lg</code>
                    or <code>.modal-xl</code> to <code>.modal-dialog</code> for additional sizes.</p>
                <div class="example">
                    <!-- Extra large modal -->
                    <button type="button" class="btn btn-primary" data-toggle="modal"
                    ...
                    <div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title h4" id="myExtraLargeModalLabel">Extra large
                                        modal</h5>
                                    <button type="button" class="close" data-dismiss="modal"
                                            aria-label="Close">
