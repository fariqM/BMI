    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
                ...
                <p class="lead">Documentation and examples for using Bootstrap custom progress bars
                    featuring support for stacked bars, animated backgrounds, and text labels. Read the <a
                        href="https://getbootstrap.com/docs/4.5/components/progress/" target="_blank">Official
                        Bootstrap Documentation</a> for a full list of instructions and other options.</p>

                <hr>

                <h4 id="default">Basic example</h4>
                <p class="mb-3">Progress components are built with two HTML elements, some CSS to set the
                    width, and a few attributes.</p>
                <div class="example">
                    <div class="progress">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="progress">
  <div class="progress-bar" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                ...
                <p class="mb-3">Add labels to your progress bars by placing text within the <code>.progress-bar</code>.
                </p>
                <div class="example">
                    <div class="progress">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="progress">
  <div class="progress-bar" role="progressbar" style="width: 25%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">25%</div>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#Labels"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">We only set a <code>height</code> value on the <code>.progress</code>, so if
                    you change that value the inner <code>.progress-bar</code> will automatically resize
                    accordingly.</p>
                <div class="example">
...
<div class="progress ht-15">
  <div class="progress-bar" role="progressbar" style="width: 75%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#Height"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Use background utility classes to change the appearance of individual
                    progress bars.</p>
                <div class="example">
                    <div class="progress">
...
<div class="progress">
  <div class="progress-bar bg-danger" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#Backgrounds"><i
                            data-feather="copy"></i></button>
                </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="progress">
  ...
  <div class="progress-bar bg-danger" role="progressbar" style="width: 20%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#MultipleBars"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Add <code>.progress-bar-striped</code> to any <code>.progress-bar</code> to
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="progress">
  <div class="progress-bar progress-bar-striped" role="progressbar" style="width: 10%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#Striped"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">The striped gradient can also be animated. Add
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="progress">
  <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style="width: 10%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#Animated"><i
                            data-feather="copy"></i></button>
                </figure>
