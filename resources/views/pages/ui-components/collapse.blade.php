    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
                ...
                <p class="lead">Toggle the visibility of content across your project with a few classes and
                    javascript. Read the <a href="https://getbootstrap.com/docs/4.5/components/collapse/"
                ...
                <p class="mb-3">Click the buttons below to show and hide another element via class
                    changes:</p>
                <div class="example">
                    <p>
                        <a class="btn btn-primary mb-1 mb-md-0" data-toggle="collapse"
...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.
                ...
                <p class="mb-3">A <code>&lt;button&gt;</code> or <code>&lt;a&gt;</code> can show and hide
                    multiple elements by referencing them with a JQuery selector in its <code>href</code> or
                    ...
                    <code>data-target</code> attribute</p>
                <div class="example">
                    <p>
                        <a class="btn btn-primary mb-1 mb-md-0" data-toggle="collapse"
                           href="#multiCollapseExample1" role="button" aria-expanded="false"
                           aria-controls="multiCollapseExample1">Toggle first element</a>
                        <button class="btn btn-primary mb-1 mb-md-0" type="button" data-toggle="collapse"
    ...
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card card-body">
        Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.
                    ...
                    <button type="button" class="btn btn-clipboard"
                            data-clipboard-target="#multipleTargets"><i data-feather="copy"></i></button>
                </figure>
