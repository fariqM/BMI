    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
                ...
                <p class="lead">A flexible and extensible content container with multiple variants and
                    options. Read the <a href="https://getbootstrap.com/docs/4.5/components/card/"
                                         target="_blank">Official Bootstrap Documentation</a> for a full
                    list of instructions and other options.</p>
                <hr>
                <h4 id="default">Basic Example</h4>
                <p class="mb-3">Below is an example of a basic card with mixed content and a fixed width.
                    Cards have no fixed width to start, so they’ll naturally fill the full width of its
                    parent element. This is easily customized with our various <a href="#sizing">sizing
                        options</a>.</p>
                <div class="example">
                    <div class="row">
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card">
                                <img src="{{ asset('assets/images/placeholder.jpg') }}" class="card-img-top"
                                     alt="...">
                                <div class="card-body">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="card">
    ...
    <div class="card-body">
      ...
      <a href="#" class="btn btn-primary">Go somewhere</a>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#defaultCard"><i
                ...
                <p class="mb-3">Cards support a wide variety of content, including images, text, list
                    groups, links, and more. Below are examples of what’s supported.</p>
                <h4 id="body">Body</h4>
                <p class="mb-3">The building block of a card is the <code>.card-body</code>. Use it whenever
                    you need a padded section within a card.</p>
                <div class="example">
                    <div class="row">
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="card">
    <div class="card-body">
      This is some text within a card body.
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#contentBody"><i
                            data-feather="copy"></i></button>
                </figure>
                <h4 id="title-text-link">Titles, text, and links</h4>
                <p class="mb-3">Subtitles are used by adding a <code>.card-subtitle</code> to a <code>&lt;h*&gt;</code>
                    tag. If the <code>.card-title</code> and the <code>.card-subtitle</code> items are
                    placed in a <code>.card-body</code> item, the card title and subtitle are aligned
                    nicely.</p>
                <div class="example">
                    <div class="row">
                        <div class="col-12 col-md-6 col-xl-4">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="card">
    <div class="card-body">
      ...
      <a href="#" class="card-link">Another link</a>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#titleText"><i
                            data-feather="copy"></i></button>
                </figure>
                <h4 id="images">Images</h4>
                <p class="mb-3"><code>.card-img-top</code> places an image to the top of the card. With
                    <code>.card-text</code>, text can be added to the card. Text within
                    <code>.card-text</code> can also be styled with the standard HTML tags.</p>
                <div class="example">
                    <div class="row">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="card">
  ...
  <div class="card">
    ...
    <img src="..." class="card-img-top" alt="...">
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#imageCard"><i
                            data-feather="copy"></i></button>
                </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="card">
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item">Vestibulum at eros</li>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#listGropus"><i
                            data-feather="copy"></i></button>
                </figure>
                <div class="example">
                    <div class="row">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="card">
    ...
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item">Vestibulum at eros</li>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#listGropus2"><i
                            data-feather="copy"></i></button>
                </figure>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text mb-1">With supporting text below as a natural
  ...
  <div class="card">
    ...
    <div class="card-footer">
      Card footer
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#headerFooter"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Cards assume no specific <code>width</code> to start, so they’ll be 100%
                    wide unless otherwise stated. You can change this as needed with custom CSS, grid
                    classes, grid Sass mixins, or utilities.</p>
                <div class="example">
                    <div class="row">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <a href="#" class="btn btn-primary">Go somewhere</a>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#cardSizing"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Add some navigation to a card’s header (or block) with Bootstrap’s nav
                    components.</p>
                <div class="example">
                    <div class="row">
                        <div class="col-12">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="card text-center">
    ...
    <div class="card-body">
      ...
      <a href="#" class="btn btn-primary">Go somewhere</a>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#cardNavigation">
                ...
                <p class="mb-3">Turn an image into a card background and overlay your card’s text. Depending
                    on the image, you may or may not need additional styles or utilities.</p>
                <div class="example">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="card text-white">
                                <img src="{{ asset('assets/images/overlay-placeholder.jpg') }}" class="card-img"
                                     alt="...">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="card text-white">
    ...
    <div class="card-img-overlay">
      ...
      <p class="card-text">Last updated 3 mins ago</p>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#imgOverlay"><i
                            data-feather="copy"></i></button>
                </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="card text-white bg-primary">
  ...
  <div class="card text-white bg-dark">
    ...
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#bgColor"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Use card groups to render cards as a single, attached element with equal
                    width and height columns. Card groups use <code>display: flex;</code> to achieve their
                    uniform sizing.</p>
                <div class="example">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="card-group">
    ...
    <div class="card"> ... </div>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#cardGroup"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Need a set of equal width and height cards that aren’t attached to one
                    another? Use card decks.</p>
                <div class="example">
                    <div class="card-deck">
                        <div class="card">
                            <img src="{{ asset('assets/images/placeholder.jpg') }}" class="card-img-top"
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="card-deck">
    ...
    <div class="card"> ... </div>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#cardDecks"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p>Cards can be organized into <a href="https://masonry.desandro.com/" target="_blank">Masonry</a>-like
                    columns with just CSS by wrapping them in <code>.card-columns</code>. Cards are built
                    with CSS <code>column</code> properties instead of flexbox for easier alignment. Cards
                    are ordered from top to bottom and left to right.</p>
                <div class="example">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#cardColumns"><i
                            data-feather="copy"></i></button>
                </figure>
