    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
                ...
                <p class="lead">Group a series of buttons together on a single line with the button group,
                    and super-power them with javascript. Read the <a
                        href="https://getbootstrap.com/docs/4.5/components/button-group/"
                        target="_blank">Official Bootstrap Documentation</a> for a full list of
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="btn-group" role="group" aria-label="Basic example">
  ...
  <button type="button" class="btn btn-primary">Right</button>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#defaultGroup"><i
                ...
                <p class="mb-3">Combine sets of button groups into button toolbars for more complex
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
  ...
  <div class="btn-group" role="group" aria-label="Third group"> ... </div>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#buttonToolbar">
                        <i data-feather="copy"></i></button>
                </figure>
                <p class="mb-3">Feel free to mix input groups with button groups in your toolbars. Similar
                    to the example above, you’ll likely need some utilities though to space things
                    properly.</p>
                <div class="example">
...
<div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
  ...
  <div class="input-group">
    ...
    <input type="text" class="form-control" placeholder="Input group example" aria-label="Input group example" aria-describedby="btnGroupAddon2">
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#mixed"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Instead of applying button sizing classes to every button in a group, just
                    add <code>.btn-group-*</code> to each <code>.btn-group</code>, including each one when
                    nesting multiple groups.</p>
                <div class="example">
                    <div class="btn-group btn-group-lg mb-1 mb-md-0" role="group"
...
<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
  ...
  <button type="button" class="btn btn-primary">Right</button>
                ...
                <p class="mb-3">Place a <code>.btn-group</code> within another <code>.btn-group</code> when
  ...
  <div class="btn-group" role="group">
    ...
    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
      ...
      <a class="dropdown-item" href="#">Dropdown link</a>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#buttonNesting">
                        <i data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Make a set of buttons appear vertically stacked rather than horizontally.
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="btn-group-vertical">
    ...
                    ...
                    <button type="button" class="btn btn-clipboard"
                            data-clipboard-target="#verticalVariations"><i data-feather="copy"></i></button>
                </figure>
