    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
                ...
                <p class="lead">List groups are a flexible and powerful component for displaying a series of
                    content. Read the <a href="https://getbootstrap.com/docs/4.5/components/list-group/"
                                         target="_blank">Official Bootstrap Documentation</a> for a full
                    list of instructions and other options.</p>
                <hr>
                <h4 id="default">Basic example</h4>
                <p class="mb-3">The most basic list group is an unordered list with list items and the
                    proper classes. Build upon it with the options that follow, or with your own CSS as
                    needed.</p>
                <div class="example">
                    <div class="row">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="list-group">
  ...
  <li class="list-group-item">Vestibulum at eros</li>
                ...
                <p class="mb-3">Add <code>.active</code> to a <code>.list-group-item</code> to indicate the
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="list-group">
  ...
  <li class="list-group-item">Vestibulum at eros</li>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#activeItems"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Add <code>.disabled</code> to a <code>.list-group-item</code> to make it
                    <em>appear</em> disabled. Note that some elements with <code>.disabled</code> will also
                    require custom JavaScript to fully disable their click events (e.g., links).</p>
                <div class="example">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <ul class="list-group">
                                <li class="list-group-item disabled" aria-disabled="true">Cras justo odio
                                </li>
                                <li class="list-group-item">Dapibus ac facilisis in</li>
                                <li class="list-group-item">Morbi leo risus</li>
                                <li class="list-group-item">Porta ac consectetur ac</li>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="list-group">
  ...
  <li class="list-group-item">Vestibulum at eros</li>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#disabledItems">
                ...
                <p class="mb-3">Use <code>&lt;a&gt;</code>s or <code>&lt;button&gt;</code>s to create
                    <em>actionable</em>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="list-group">
  ...
  <a href="#" class="list-group-item list-group-item-action disabled" tabindex="-1" aria-disabled="true">Vestibulum at eros</a>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#linksButtons"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Add <code>.list-group-flush</code> to remove some borders and rounded
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="list-group list-group-flush">
  ...
  <li class="list-group-item">Vestibulum at eros</li>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#Flush"><i
                            data-feather="copy"></i></button>
                </figure>
