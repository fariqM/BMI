    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
                ...
                <p class="lead">Use Bootstrap’s custom button styles for actions in forms, dialogs, and more
                    with support for multiple sizes, states, and more. Read the <a
                        href="https://getbootstrap.com/docs/4.5/components/buttons/" target="_blank">Official
                        Bootstrap Documentation</a> for a full list of instructions and other options.</p>
                <hr>
                <h4 id="default">Basic Examples</h4>
                <p class="mb-3">Bootstrap includes several predefined button styles, each serving its own
...
<button type="button" class="btn btn-link">Link</button></script></code></pre>
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#defaultButton">
                ...
                <p class="mb-3">The <code>.btn</code> classes are designed to be used with the
                    <code>&lt;button&gt;</code>
...
<input class="btn btn-primary" type="reset" value="Reset"></script></code></pre>
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#tagsButton"><i
                ...
                <p class="mb-3">In need of a button, but not the hefty background colors they bring? Replace
                ...
                <figure class="highlight" id="outlineButton">
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#outlineButton">
                        <i data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Fancy larger or smaller buttons? Add <code>.btn-lg</code> or
                    <code>.btn-sm</code> for additional sizes.</p>
                <div class="example">
                    <button type="button" class="btn btn-primary btn-lg mr-1 mb-1 mb-md-0">Large button
                    </button>
                    <button type="button" class="btn btn-primary mr-1 mb-1 mb-md-0">Default button</button>
                    <button type="button" class="btn btn-primary btn-sm mr-1 mb-1 mb-md-0">Small button
                    </button>
...
<button type="button" class="btn btn-primary btn-xs">Extra small</button></script></code></pre>
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#buttonSizes"><i
                            data-feather="copy"></i></button>
                </figure>
                <p class="mb-3">Create block level buttons—those that span the full width of a parent—by
                    adding <code>.btn-block</code>.</p>
                <div class="example">
...
<button type="button" class="btn btn-secondary btn-block">Block level button</button></script></code></pre>
                    <button type="button" class="btn btn-clipboard"
                            data-clipboard-target="#defaultBreadcrumbs"><i data-feather="copy"></i></button>
                </figure>

                <hr>

                <h4 id="active">Active state</h4>
                <p class="mb-3">Buttons will appear pressed (with a darker background, darker border, and
                    inset shadow) when active. <strong>There’s no need to add a class to <code>&lt;button&gt;</code>s
                        as they use a pseudo-class</strong>. However, you can still force the same active
                    appearance with <code>.active</code> (and include the <code>aria-pressed="true"</code>
                    attribute) should you need to replicate the state programmatically.</p>
                <div class="example">
                    <a href="#" class="btn btn-primary active" role="button" aria-pressed="true">Primary
                        link</a>
...
<a href="#" class="btn btn-secondary active" role="button" aria-pressed="true">Link</a></script></code></pre>
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#activeButton"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Make buttons look inactive by adding the <code>disabled</code> boolean
                    attribute to any <code>&lt;button&gt;</code> element.</p>
                <div class="example">
...
<button type="button" class="btn btn-secondary" disabled>Button</button></script></code></pre>
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#disabledButton">
                        <i data-feather="copy"></i></button>
                </figure>
                <p class="mb-3">Disabled buttons using the <code>&lt;a&gt;</code> element behave a bit
                    different. <code>&lt;a&gt;</code>s don’t support the <code>disabled</code> attribute, so
                    you must add the <code>.disabled</code> class to make it visually appear disabled.</p>
                <div class="example">
                    <a href="#" class="btn btn-primary disabled" tabindex="-1" role="button"
                       aria-disabled="true">Primary link</a>
                    <a href="#" class="btn btn-secondary disabled" tabindex="-1" role="button"
...
<a href="#" class="btn btn-secondary disabled" tabindex="-1" role="button" aria-disabled="true">Link</a></script></code></pre>
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#defaultButton2">
                        <i data-feather="copy"></i></button>
                </figure>
...
<button type="button" class="btn btn-danger btn-icon">
	<i data-feather="box"></i>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#withIcon"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Wrap icon and text inside <code>.btn-icon-text</code> and use
...
<button type="button" class="btn btn-primary btn-icon-text">
	...
	<i class="btn-icon-append" data-feather="box"></i>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#withIconText"><i
                            data-feather="copy"></i></button>
                </figure>
