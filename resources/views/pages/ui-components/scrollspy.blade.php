    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
                ...
                <p class="lead">Navigation or list group components based on scroll position to indicate
                    which link is currently active in the viewport. Read the <a
                        href="https://getbootstrap.com/docs/4.5/components/scrollspy/" target="_blank">Official
                        Bootstrap Documentation</a> for a full list of instructions and other options.</p>

                <hr>

                <h4 id="default">Example in navbar</h4>
                <p class="mb-3">Scroll the area below the navbar and watch the active class change. The
                    dropdown items will be highlighted as well.</p>
                <div class="example">
                    ...
                    <div data-spy="scroll" data-target="#navbar-example1" data-offset="0"
...
<div data-spy="scroll" data-target="#navbar-example2" data-offset="0">
  ...
  <p>...</p>
                ...
                <p class="mb-3">Scrollspy also works with nested <code>.nav</code>s. If a nested
                    <code>.nav</code> is <code>.active</code>, its parents will also be <code>.active</code>.
                    Scroll the area next to the navbar and watch the active class change.</p>
                <div class="example">
                    <div class="row">
...
<div data-spy="scroll" data-target="#navbar-example3" data-offset="0">
  ...
  <p>...</p>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#NestedNav"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Scrollspy also works with <code>.list-group</code>s. Scroll the area next to
...
<div data-spy="scroll" data-target="#list-example" data-offset="0" class="scrollspy-example">
  ...
  <p>...</p>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#ListGroup"><i
                            data-feather="copy"></i></button>
                </figure>
