    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
                ...
                <p class="lead">Provide contextual feedback messages for typical user actions with the
                    handful of available and flexible alert messages. Read the
                ...
                <p class="mb-3">Alerts are available for any length of text, as well as an optional dismiss
                    button. For proper styling, use one of the eight required contextual classes (e.g.,
                    <code>.alert-success</code>).</p>
                <div class="example">
...
<pre>
    <code class="language-markup">
        <script type="script/prism-html-markup">
        <div class="alert alert-primary" role="alert">
	A simple primary alert—check it out!
</div>
...
<div class="alert alert-dark" role="alert">...</div>
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#defaultAlert">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="alert alert-fill-primary" role="alert">
	A simple primary alert—check it out!
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#fillAlert"><i
                ...
                <p class="mb-3">Add class <code>.alert-icon-*</code> with <code>.alert</code>. then include
                    an icon inside the div.</p>
                <div class="example">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="alert alert-icon-primary" role="alert">
	...
	A simple primary alert—check it out!
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#iconAlert"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Use the <code>.alert-link</code> utility class to quickly provide matching
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="alert alert-primary" role="alert">
	A simple primary alert with <a href="#" class="alert-link">an example link</a>. Give it a click if you like.
                    ...
                    <button type="button" class="btn btn-clipboard" data-clipboard-target="#linkAlert"><i
                            data-feather="copy"></i></button>
                </figure>
                ...
                <p class="mb-3">Alerts can also contain additional HTML elements like headings, paragraphs
                    and dividers.</p>
                <div class="example">
                    <div class="alert alert-success" role="alert">
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="alert alert-success" role="alert">
	...
	<p class="mb-0">Whenever you need to, be sure to use margin utilities to keep things nice and tidy.</p>
                    ...
                    <button type="button" class="btn btn-clipboard"
                            data-clipboard-target="#additionalContent"><i data-feather="copy"></i></button>
                </figure>
                <hr>
                <h4 id="dismissing">Dismissing</h4>
                <p class="mb-3">Using the alert JavaScript plugin, it’s possible to dismiss any alert
                    inline.</p>
                <ul>
                    <li>Add a dismiss button and the <code>.alert-dismissible</code> class, which adds extra
                        padding to the right of the alert and positions the <code>.close</code> button.
                    </li>
                    <li>On the dismiss button, add the <code>data-dismiss="alert"</code> attribute, which
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="alert alert-warning alert-dismissible fade show" role="alert">
	...
	<button type="button" class="close" data-dismiss="alert" aria-label="Close">
		<span aria-hidden="true">&times;</span>
                    ...
                    <button type="button" class="btn btn-clipboard"
                            data-clipboard-target="#dismissingAlert"><i data-feather="copy"></i></button>
                </figure>
