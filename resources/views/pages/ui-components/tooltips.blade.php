    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
                ...
                <p class="lead">Documentation and examples for adding custom Bootstrap tooltips with CSS and
                    JavaScript using CSS3 for animations and data-attributes for local title storage. Read
                    the <a href="https://getbootstrap.com/docs/4.5/components/tooltips/" target="_blank">Official
                        Bootstrap Documentation</a> for a full list of instructions and other options.</p>

                <hr>

                <h4 id="enable">Enable tooltips everywhere</h4>
                <p class="mb-3">One way to initialize all tooltips on a page would be to select them by
...
<pre><code class="language-javascript"><script type="script/prism-html-markup">$(function () {
  $('[data-toggle="tooltip"]').tooltip()
                ...
                <div class="example">
                    <button type="button" class="btn btn-primary mb-1 mb-md-0" data-toggle="tooltip"
