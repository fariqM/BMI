                            ...
                            <div class="col-lg-3 email-aside border-lg-right">
                                <div class="aside-content">
                                    ...
                                    <div class="aside-compose">
                                        <a class="btn btn-primary btn-block" href="/email/compose">
                                            Compose Email
                                        </a>
                                    </div>
                                        ...
                                        <div class="form-group row pt-1 pb-3">
                                            ...
                                            <div class="col-md-11">
                                                <select class="compose-multiple-select form-control w-100"
                                                    ...
                                                    <option value="Alaska" selected="selected">Alaska
                                                    </option>
                                                    <option value="Melbourne">Melbourne</option>
                                                    <option value="Victoria" selected="selected">Victoria
                                                    </option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label sr-only"
                                                   for="simpleMdeEditor">Descriptions </label>
                                            <textarea class="form-control" name="tinymce"
                                                      id="simpleMdeEditor" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="email action-send">
                                        <div class="col-md-12">
                                            <div class="form-group mb-0">
                                                ...
                                                <button class="btn btn-light btn-space" type="button">
                                                    Cancel
                                                </button>
                                            </div>
                                        </div>
