                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description mb-0">Read the <a
                                href="https://github.com/fengyuanchen/cropperjs" target="_blank"> Official
                                CropperJs Documentation </a>for a full list of instructions and other options.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                          ...
                          <button class="file-upload-browse btn btn-primary" type="button">Upload</button>
                                ...
                                <div>
                                    <img src="{{ asset('assets/images/sample3.jpg') }}" class="w-100" id="croppingImage"
                                         alt="cropper">
                                </div>
                                <div class="d-flex justify-content-between align-items-center flex-wrap">
                                    <div class="form-group d-flex align-items-center flex-wrapp mb-0 mr-2 mt-3">
                                        <label class="w-50 mr-3 mb-0 mb-2 mb-md-0 text-nowrap">Width (px)
                                            :</label>
                                        <input type="number" value="300"
                                               class="form-control img-w mr-2 mb-2 mb-md-0 w-75"
