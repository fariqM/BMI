                ...
                <div class="col-12 grid-margin">
                    <div class="profile-header">
                        <div class="cover">
                            ...
                            <figure>
                                <img src="{{ asset('assets/images/profile-cover.jpg') }}" class="img-fluid"
                                     alt="profile cover">
                            </figure>
                            <div class="cover-body d-flex justify-content-between align-items-center">
                                <div>
                                    <img class="profile-pic" src="{{ asset('assets/images/faces/face1.jpg') }}"
                                         alt="profile">
                ...
                <div class="d-none d-md-block col-md-4 col-xl-3 left-wrapper">
                    <div class="card rounded">
                        <div class="card-body">
                            ...
                            <p>Hi! I'm Amiah the Senior UI Designer at NobleUI. We hope you enjoy the design
                                and quality of Social.</p>
                            <div class="mt-3">
                    ...
                    <div class="row">
                        <div class="col-md-12 grid-margin">
                            <div class="card rounded">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu"
                                                ...
                                                <a class="dropdown-item d-flex align-items-center" href="#"><i
                                                        data-feather="share-2" class="icon-sm mr-2"></i>
                                ...
                                <div class="card-body">
                                    <p class="mb-3 tx-14">Lorem ipsum dolor sit amet, consectetur
                                        adipisicing elit. Accusamus minima delectus nemo unde quae
                                        recusandae assumenda.</p>
                                    <img class="img-fluid" src="{{ asset('assets/images/sample1.jpg') }}" alt="">
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card rounded">
                                ...
                                <div class="card-body">
                                    <p class="mb-3 tx-14">Lorem ipsum dolor sit amet, consectetur
                                        adipisicing elit.</p>
                                    <img class="img-fluid" src="{{ asset('assets/images/sample2.jpg') }}" alt="">
                                </div>
                                <div class="card-footer">
                                    <div class="d-flex post-actions">
                                        <a href="javascript:;"
                                    ...
                                    <div class="latest-photos">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <figure class="mb-0">
                                                    <img class="img-fluid"
                                                         src="{{ asset('assets/images/faces/face7.jpg') }}"
                                                         alt="">
                                                </figure>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                <figure class="mb-0">
                                                    <img class="img-fluid"
                                                         src="{{ asset('assets/images/faces/face9.jpg') }}"
                                                         alt="">
                                                </figure>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                                        <div class="d-flex align-items-center hover-pointer">
                                            <img class="img-xs rounded-circle"
                                                 src="{{ asset('assets/images/faces/face2.jpg') }}" alt="">
                                            <div class="ml-2">
                                                <p>Mike Popescu</p>
                                    ...
                                    <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                                        <div class="d-flex align-items-center hover-pointer">
                                            <img class="img-xs rounded-circle"
                                                 src="{{ asset('assets/images/faces/face3.jpg') }}" alt="">
                                            <div class="ml-2">
                                                <p>Mike Popescu</p>
                                                <p class="tx-11 text-muted">12 Mutual Friends</p>
                                            </div>
                                    ...
                                    <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                                        <div class="d-flex align-items-center hover-pointer">
                                            <img class="img-xs rounded-circle"
                                                 src="{{ asset('assets/images/faces/face4.jpg') }}" alt="">
                                            <div class="ml-2">
                                                <p>Mike Popescu</p>
                                                <p class="tx-11 text-muted">12 Mutual Friends</p>
                                            </div>
                                    ...
                                    <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                                        <div class="d-flex align-items-center hover-pointer">
                                            <img class="img-xs rounded-circle"
                                                 src="{{ asset('assets/images/faces/face5.jpg') }}" alt="">
                                            <div class="ml-2">
                                                <p>Mike Popescu</p>
                                                <p class="tx-11 text-muted">12 Mutual Friends</p>
                                            </div>
                                    ...
                                    <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                                        <div class="d-flex align-items-center hover-pointer">
                                            <img class="img-xs rounded-circle"
                                                 src="{{ asset('assets/images/faces/face6.jpg') }}" alt="">
                                            <div class="ml-2">
                                                <p>Mike Popescu</p>
                                                <p class="tx-11 text-muted">12 Mutual Friends</p>
                                            </div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex align-items-center hover-pointer">
                                            <img class="img-xs rounded-circle"
                                                 src="{{ asset('assets/images/faces/face7.jpg') }}" alt="">
                                            <div class="ml-2">
                                                <p>Mike Popescu</p>
                                                <p class="tx-11 text-muted">12 Mutual Friends</p>
                                            </div>
