            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted text-center mb-4 pb-2">Choose the features and functionality
                            your team need today. Easily upgrade as your company grows.</p>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4 stretch-card grid-margin grid-margin-md-0">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-center mb-4 font-weight-light">per
                                                month</p>
                                            <h6 class="text-muted text-center mb-4 font-weight-normal">Up to
                                                25 units</h6>
                                            ...
                                            <button class="btn btn-primary d-block mx-auto mt-4">Star free
                                                trial
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 stretch-card grid-margin grid-margin-md-0">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="text-center text-uppercase mt-3 mb-4 font-weight-light">
                                                Business</h4>
                                            <i data-feather="gift"
                                               class="text-success icon-xxl d-block mx-auto my-3"></i>
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                <i data-feather="check"
                                                   class="icon-md text-danger mr-2"></i>
                                                <p>Accounting dashboard</p>
                                            </div>
                                            <div class="d-flex align-items-center mb-2">
                                                <i data-feather="check"
                                            ...
                                            <button class="btn btn-success d-block mx-auto mt-4">Star free
                                                trial
                                            </button>
                                        </div>
                                    </div>
