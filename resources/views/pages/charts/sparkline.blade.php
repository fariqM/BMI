    ...
    <div class="page-content">
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">jQuery Sparkline Charts <span id="mouseSpeedChart"></span>
                        </h6>
                        <p>This jQuery plugin generates sparklines (small inline charts) directly in the
                            browser using data supplied either inline in the HTML, or via javascript. Read
                            the <a href="https://omnipotent.net/jquery.sparkline/" target="_blank"> Official
                                jQuery Sparklines Documentation</a> for a full list of instructions and
                            other options.</p>
                    </div>
                </div>
            </div>
